...
// user can increase decrease the items in the cart also can see the qty.
      ...
      <>
        ...
        <div className={cartPageStyles.emptyCartContainer}>
          <div className={cartPageStyles.emptyCartCard}>
            ...
            <p className={cartPageStyles.emptyCartDescription}>
