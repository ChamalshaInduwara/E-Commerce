...
const VerifyPaymentPage = () => {
  ...
  useEffect(() => {
    ...
    try {
       ...
       const resp = await axios.get(`${API_BASE}/api/orders/confirm` , {
        params: { session_id },
    ...
    <div className=" min-h-screen flex items-center justify-center text-white p-4">
        <div className=" text-center max-w-lg">
            ...
            <p className=" text-sm opacity-70">
                If this page shows "session not found", try creating the session again. Or contact with the support.
            </p>
        </div>
    </div>
  )
...
// for the payment to be paid and order place we required this
